...
export const Reports: FC<IProps> = () => {
    ...
    const onSubmitForm = async (
        ...
        try {
            ...
            await questionsService.APIupdateQuestion(question?._id, payload);
            mutate();
    ...
    return (
        <DefaultLayout title="Tổng hợp báo cáo">
            ...
            <PageTransittion>
                <button
                    className="outline-none sm:hidden absolute top-0 right-0 m-3 focus:outline-none text-white hover:bg-white hover:bg-opacity-25 transition duration-300 rounded-full flex items-center justify-center p-1"
                    type="button"
                    // onClick={toggleModal}
                >
                    <svg
                ...
                {reports &&
                    (reports.length === 0 ? (
                        ...
                        <div className="w-full h-full text-white z-10 flex mt-12 px-4 sm:px-8 md:px-20 lg:px-56">
                            <div
                                style={{ maxHeight: '550px', width: '350px' }}
                            ...
                            <div className="z-10 px-4 sm:px-10 w-full">
                                <Alert
                                    isSuccess={isSuccess}
                                    message={message}
